...
FAMILY_OUTDIR=vendor/$VENDOR/$FAMILY_DEVICE
FAMILY_MAKEFILE=../../../$FAMILY_OUTDIR/$FAMILY_DEVICE-vendor-blobs.mk
FAMILY_VENDOR_MAKEFILE=../../../$FAMILY_OUTDIR/$FAMILY_DEVICE-vendor.mk
...
if [ -f ../$FAMILY_DEVICE/proprietary-files.txt ]; then
LINEEND=" \\"
COUNT=`wc -l ../$FAMILY_DEVICE/proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../$FAMILY_DEVICE/proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
for FILE in `egrep -v '(^#|^$)' ../$FAMILY_DEVICE/proprietary-files.txt`; do
  COUNT=`expr $COUNT - 1`
  if [ $COUNT = "0" ]; then
    LINEEND=""
  fi
...
if [ ! -z $FAMILY_DEVICE ]; then
  echo "\$(call inherit-product, vendor/$VENDOR/$FAMILY_DEVICE/$FAMILY_DEVICE-vendor.mk)" >> $VENDOR_MAKEFILE
fi
...
# Start extraction of family files
...
# This file is generated by device/$VENDOR/$FAMILY_DEVICE/setup-makefiles.sh

PRODUCT_COPY_FILES += \\
EOF

LINEEND=" \\"
COUNT=`wc -l ../$FAMILY_DEVICE/common-proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../$FAMILY_DEVICE/common-proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
for FILE in `egrep -v '(^#|^$)' ../$FAMILY_DEVICE/common-proprietary-files.txt`; do
  COUNT=`expr $COUNT - 1`
  if [ $COUNT = "0" ]; then
    LINEEND=""
  fi
  ...
  if [[ ! "$FILE" =~ ^-.* ]]; then
    ...
    echo "    $FAMILY_OUTDIR/proprietary/$FILE:system/$FILE$LINEEND" >> $FAMILY_MAKEFILE
  fi
done
...
ifneq (\$(filter $FAMILY_DEVICE_LIST,\$(TARGET_DEVICE)),)
...
\$(call inherit-product, vendor/$VENDOR/$FAMILY_DEVICE/$FAMILY_DEVICE-vendor-blobs.mk)
...
if [ ! -z $BOARD_VENDOR ]; then
  echo "ifeq (\$(BOARD_VENDOR),$BOARD_VENDOR)" >> ../../../$FAMILY_OUTDIR/proprietary/app/Android.mk
fi
echo "ifeq (\$(TARGET_BOARD_PLATFORM),$TARGET_BOARD_PLATFORM)" >> ../../../$FAMILY_OUTDIR/proprietary/app/Android.mk
echo ""  >> ../../../$FAMILY_OUTDIR/proprietary/app/Android.mk
echo "# Prebuilt APKs" >> $FAMILY_VENDOR_MAKEFILE
echo "PRODUCT_PACKAGES += \\" >> $FAMILY_VENDOR_MAKEFILE

LINEEND=" \\"
COUNT=`ls -1 ../../../$FAMILY_OUTDIR/proprietary/app/*/*.apk | wc -l`
for APK in `ls ../../../$FAMILY_OUTDIR/proprietary/app/*/*apk`; do
  COUNT=`expr $COUNT - 1`
  if [ $COUNT = "0" ]; then
    LINEEND=""
  fi
...
echo "    $apkmodulename$LINEEND" >> $FAMILY_VENDOR_MAKEFILE
done
echo "" >> $FAMILY_VENDOR_MAKEFILE
echo "endif" >> ../../../$FAMILY_OUTDIR/proprietary/app/Android.mk
if [ ! -z $BOARD_VENDOR ]; then
  echo "endif" >> ../../../$FAMILY_OUTDIR/proprietary/app/Android.mk
fi
fi
...
if [ ! -z $BOARD_VENDOR ]; then
  echo "ifeq (\$(BOARD_VENDOR),$BOARD_VENDOR)" >> ../../../$FAMILY_OUTDIR/proprietary/framework/Android.mk
fi
echo "ifeq (\$(TARGET_BOARD_PLATFORM),$TARGET_BOARD_PLATFORM)" >> ../../../$FAMILY_OUTDIR/proprietary/framework/Android.mk
echo ""  >> ../../../$FAMILY_OUTDIR/proprietary/framework/Android.mk
echo "# Prebuilt jars" >> $FAMILY_VENDOR_MAKEFILE
echo "PRODUCT_PACKAGES += \\" >> $FAMILY_VENDOR_MAKEFILE

LINEEND=" \\"
COUNT=`ls -1 ../../../$FAMILY_OUTDIR/proprietary/framework/*.jar | wc -l`
for JAR in `ls ../../../$FAMILY_OUTDIR/proprietary/framework/*jar`; do
  COUNT=`expr $COUNT - 1`
  if [ $COUNT = "0" ]; then
    LINEEND=""
  fi
...
echo "    $jarmodulename$LINEEND" >> $FAMILY_VENDOR_MAKEFILE
done
echo "" >> $FAMILY_VENDOR_MAKEFILE
echo "endif" >> ../../../$FAMILY_OUTDIR/proprietary/framework/Android.mk
if [ ! -z $BOARD_VENDOR ]; then
  echo "endif" >> ../../../$FAMILY_OUTDIR/proprietary/framework/Android.mk
fi
fi
...
if [ ! -z $BOARD_VENDOR ]; then
  echo "ifeq (\$(BOARD_VENDOR),$BOARD_VENDOR)" >> ../../../$FAMILY_OUTDIR/proprietary/priv-app/Android.mk
fi
echo "ifeq (\$(TARGET_BOARD_PLATFORM),$TARGET_BOARD_PLATFORM)" >> ../../../$FAMILY_OUTDIR/proprietary/priv-app/Android.mk
echo ""  >> ../../../$FAMILY_OUTDIR/proprietary/priv-app/Android.mk
echo "# Prebuilt privileged APKs" >> $FAMILY_VENDOR_MAKEFILE
echo "PRODUCT_PACKAGES += \\" >> $FAMILY_VENDOR_MAKEFILE

LINEEND=" \\"
COUNT=`ls -1 ../../../$FAMILY_OUTDIR/proprietary/priv-app/*/*.apk | wc -l`
for PRIVAPK in `ls ../../../$FAMILY_OUTDIR/proprietary/priv-app/*/*apk`; do
  COUNT=`expr $COUNT - 1`
  if [ $COUNT = "0" ]; then
    LINEEND=""
  fi
...
echo "    $privmodulename$LINEEND" >> $FAMILY_VENDOR_MAKEFILE
done
echo "" >> $FAMILY_VENDOR_MAKEFILE
echo "endif" >> ../../../$FAMILY_OUTDIR/proprietary/priv-app/Android.mk
if [ ! -z $BOARD_VENDOR ]; then
  echo "endif" >> ../../../$FAMILY_OUTDIR/proprietary/priv-app/Android.mk
fi
fi

LIBS=`cat ../$FAMILY_DEVICE/common-proprietary-files.txt | grep '\-lib' | cut -d'-' -f2 | head -1`
...
if [ ! -z $BOARD_VENDOR ]; then
  echo "ifeq (\$(BOARD_VENDOR),$BOARD_VENDOR)" >> ../../../$FAMILY_OUTDIR/proprietary/lib/Android.mk
fi
echo "ifeq (\$(TARGET_BOARD_PLATFORM),$TARGET_BOARD_PLATFORM)" >> ../../../$FAMILY_OUTDIR/proprietary/lib/Android.mk
echo ""  >> ../../../$FAMILY_OUTDIR/proprietary/lib/Android.mk
echo "# Prebuilt libs needed for compilation" >> $FAMILY_VENDOR_MAKEFILE
echo "PRODUCT_PACKAGES += \\" >> $FAMILY_VENDOR_MAKEFILE

LINEEND=" \\"
COUNT=`cat ../$FAMILY_DEVICE/common-proprietary-files.txt | grep '\-lib' | wc -l`
for LIB in `cat ../$FAMILY_DEVICE/common-proprietary-files.txt | grep '\-lib' | cut -d'/' -f2`;do
  COUNT=`expr $COUNT - 1`
  if [ $COUNT = "0" ]; then
    LINEEND=""
  fi
...
echo "    $libmodulename$LINEEND" >> $FAMILY_VENDOR_MAKEFILE
done
echo "" >> $FAMILY_VENDOR_MAKEFILE
echo "endif" >> ../../../$FAMILY_OUTDIR/proprietary/lib/Android.mk
if [ ! -z $BOARD_VENDOR ]; then
  echo "endif" >> ../../../$FAMILY_OUTDIR/proprietary/lib/Android.mk
fi
fi

VENDORLIBS=`cat ../$FAMILY_DEVICE/common-proprietary-files.txt | grep '\-vendor\/lib' | cut -d'-' -f2 | head -1`
...
if [ ! -z $BOARD_VENDOR ]; then
  echo "ifeq (\$(BOARD_VENDOR),$BOARD_VENDOR)" >> ../../../$FAMILY_OUTDIR/proprietary/vendor/lib/Android.mk
fi
echo "ifeq (\$(TARGET_BOARD_PLATFORM),$TARGET_BOARD_PLATFORM)" >> ../../../$FAMILY_OUTDIR/proprietary/vendor/lib/Android.mk
echo ""  >> ../../../$FAMILY_OUTDIR/proprietary/vendor/lib/Android.mk
echo "# Prebuilt vendor/libs needed for compilation" >> $FAMILY_VENDOR_MAKEFILE
echo "PRODUCT_PACKAGES += \\" >> $FAMILY_VENDOR_MAKEFILE

LINEEND=" \\"
COUNT=`cat ../$FAMILY_DEVICE/common-proprietary-files.txt | grep '\-vendor\/lib' | wc -l`
for VENDORLIB in `cat ../$FAMILY_DEVICE/common-proprietary-files.txt | grep '\-vendor\/lib' | cut -d'/' -f3`;do
  COUNT=`expr $COUNT - 1`
  if [ $COUNT = "0" ]; then
    LINEEND=""
  fi
...
echo "    $vendorlibmodulename$LINEEND" >> $FAMILY_VENDOR_MAKEFILE
done
echo "endif" >> ../../../$FAMILY_OUTDIR/proprietary/vendor/lib/Android.mk
if [ ! -z $BOARD_VENDOR ]; then
  echo "endif" >> ../../../$FAMILY_OUTDIR/proprietary/vendor/lib/Android.mk
fi
fi
